...
export function About({ experience }: AboutProps) {
  ...
  const {
    ...
    intro,
    body,
    image = '/images/homepage/construction-about.webp',
    missionStatement = "Engineered for endurance. Built for impact.",
    valuesHeading = "Our Core Principles",
    values = [
      { title: "Structural Integrity", description: "Uncompromising standards in engineering and material selection." },
      { title: "Precision Execution", description: "Meticulous site management ensuring millimeter-perfect delivery." },
      { title: "Safety First", description: "Rigorous protocols protecting our teams, clients, and the environment." }
    ]
          ...
          <ScrollReveal delay={0.15} direction="up" className="w-full">
            ...
            */}
            <div className="relative w-full aspect-square sm:aspect-video lg:aspect-[21/9] rounded-xl sm:rounded-2xl md:rounded-[2rem] overflow-hidden shadow-2xl group">
              <Image
                src="/images/construction/construction-about.png"
                alt={`${experience.name} construction site`}
                fill
                sizes="100vw"
