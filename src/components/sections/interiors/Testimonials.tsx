    ...
    <section id="testimonials" className="section bg-white py-24 lg:py-36 border-b border-neutral-100 overflow-hidden" aria-labelledby="testimonials-heading">
      ...
      <div className="relative w-full overflow-hidden flex items-center">
        ...
        <motion.div
          ...
          whileHover={{ animationPlayState: 'paused' }} // We can pause it if needed using CSS, but framer motion whileHover doesn't pause x-animation natively this simply. We'll leave it flowing smoothly.
        >
